# -*- coding: utf-8 -*-
"""Heuristic for HeuDiConv in converting PPMI data into BIDS format."""
...
def create_key(template, outtype=('nii.gz',), annotation_classes=None):
    """Create a key for the heuristic."""
...
def custom_callable(*args):
    """
    Call at the end of `heudiconv.convert.convert()` to perform clean-up.
